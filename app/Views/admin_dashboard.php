    ...
    <span><?= esc(session()->get('name')) ?></span>
            ...
            <div class="dashboard-grid">
                <div class="dashboard-item">
                    ...
                    <button class="action-btn" onclick="location.href='<?= base_url('admin/addPermission') ?>'">إضافة</button>
                </div>
                ...
                <div class="dashboard-item">
                    ...
                    <button class="action-btn" onclick="location.href='<?= base_url('admin/listPermissions') ?>'">تحديث</button>
                </div>
                ...
                <div class="dashboard-item">
                    ...
                    <button class="action-btn" onclick="location.href='<?= base_url('admin/addEmployee') ?>'">إضافة الموظف</button>  
                </div>
