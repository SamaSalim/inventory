    ...
    <div class="main-content">
        <div class="container">
            ...
            <?php if (isset($permission) && !empty($permission)): ?>
                ...
                <?= form_open('admin/updatePermission/' . esc($permission->id), ['id' => 'updateForm']) ?>
                ...
                <div class="delete-section">
                    ...
                    <form action="<?= base_url('admin/deletePermission/' . esc($permission->id)) ?>" method="post" id="deleteForm">
            ...
            <?php else: ?>
                <div class="not-found">
                    ...
                    <p>يرجى التأكد من الرابط أو الانتقال إلى
                        <a href="<?= base_url('admin/addPermission') ?>">صفحة إضافة الصلاحيات</a>.
                    </p>
                </div>
            <?php endif; ?>
        </div>
