        ...
        <div class="container">
                    ...
                    <tbody>
                        <?php foreach ($permissions as $permission): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('admin/updatePermission/' . $permission->id) ?>" class="action-btn">
                                        ✏ تعديل
                                    </a>
                                    <form action="<?= base_url('admin/deletePermission/' . $permission->id) ?>" method="post" style="display:inline;" onsubmit="return confirm('هل أنت متأكد من حذف هذه الصلاحية؟')">
            ...
            <?php else: ?>
                <div class="no-permissions">
                    ...
                    <a href="<?= base_url('admin/addPermission') ?>" class="action-btn" style="margin-top: 20px;">
                        إضافة صلاحية جديدة
                    </a>
                </div>
            <?php endif; ?>
