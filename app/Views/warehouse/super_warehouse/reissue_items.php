...
<script>
    ...
    function updateSelectedItems() {
        ...
        checkboxes.forEach(cb => {
            ...
            const itemData = {
                id: cb.value,
                item_order_id: cells[1].textContent.trim(),
                asset_num: cells[2].textContent.trim(),
                serial_num: cells[3].textContent.trim(),
                item_name: cells[4].textContent.trim(),
                brand: cells[5].textContent.trim(),
                model: cells[6].textContent.trim(),
            ...
            itemsHTML += `
                <div class="popup-item">
                    <div class="item-header">
                        ...
                        <span class="item-number">${item.item_order_id}</span>
                    </div>
