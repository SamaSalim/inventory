...
class OrderModel extends Model
{
    ...
    protected $allowedFields = ['from_employee_id', 'to_employee_id', 'order_status_id', 'note'];
    protected $useTimestamps = true;

    protected $validationRules = [
        'from_employee_id' => 'required|max_length[50]|is_not_unique[employee.emp_id]',
        'to_employee_id' => 'required|max_length[50]|is_not_unique[employee.emp_id]',
